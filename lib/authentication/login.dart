...
//                     selectedColor: primaryColor, unselectedColor: Colors.white),
//                 buttons: const ['Seller', 'Buyer'],
...
//               onTap: () {
//                 if (length == 10) {
//                   AuthRepo().sendOTP(phoneController.text, context);
//                 } else {
//                   showDialog(
//                       context: context,
//                       builder: (context) {
...
//                           content: const Text('Phone number is invalid'),
//                           actions: [
//                             MaterialButton(
...
//                   AuthRepo().getToken(widget.otp, widget.phone, context);
//                 } else {
//                   showDialog(
//                       context: context,
//                       builder: (context) {
...
//   @override
//   void initState() {
//     print(widget.data['data']['data']['gstin'].toString());
